        ...
        <header className="bg-gray-800 w-full h-screen flex justify-center items-center">
            ...
            <div className="flex flex-col w-full h-full">
                <div className="flex items-center justify-center" style={{ flex: 2 }}>
                    <h1 className="z-30 text-white text-4xl font-medium mt-40"><span className="font-semibold">Hola mundo, soy Piero Rolando,</span> <br /> un desarrollador de software</h1>
                </div>
    ...
    return (
        <main className="w-full bg-red-600 flex items-center justify-center" id="main" style={{ height: '70vh' }}>
            <div className="max-w-7xl h-full bg-green-400" style={{ flex: 1 }} >
                ...
                <div className="flex items-center justify-center"><p className="w-2/4">MoureDev es el reflejo de mi ilusión por crecer como profesional dentro de la industria del desarrollo del software. Como freelance, me he especializado en desarrollo de aplicaciones iOS, Android y web.</p></div>
            </div>
        </main>
    )
}