...
const PostElementLoading = () => {
  ...
  <div className="max-w-4xl px-10 py-6 bg-gray-800 rounded-lg shadow-xl">
    ...
    <div className="mt-2">
      <div href="#" className="text-2xl text-gray-300 font-bold hover:underline bg-gray-600 w-11/12 rounded-md h-8 animate-pulse"></div>
    ...
    <div className="flex justify-between items-center mt-4">
      ...
      <div>
        <a href="#" className="flex items-center"
          ><div alt="avatar" className="mx-4 w-10 h-10 object-cover rounded-full hidden sm:block bg-gray-900 animate-pulse"></div>
