...
export const EditPostPlaceholder = () => {
    return (
        <GeneralPage>
            <div className="h-full min-h-screen bg-gray-900 cursor-default">
                <div className="image-container relative">
                    <div className="w-full h-full absolute bg-gray-800 bg-opacity-80 flex flex-col p-14 animate-pulse">
