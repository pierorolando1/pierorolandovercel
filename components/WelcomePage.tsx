        ...
        <header className="bg-primary-900 w-full h-screen flex justify-center items-center">
            ...
            <div className="flex flex-col w-full h-full">
                ...
                <div className="flex items-center justify-center z-10" style={{ flex: 1 }}>
                    <a href="#main" className="w-14 h-14 bg-accent hover:bg-accent-hover bg-opacity-60 transition-all hover:shadow-2xl shadow-xl flex justify-center items-center cursor-pointer animate-bounce">
