        ...
        <header className="bg-gray-800 w-full h-screen flex justify-center items-center">
            ...
            <div className="flex flex-col w-full h-full">
                <div className="flex items-center justify-center" style={{ flex: 2 }}>
                    <h1 className="z-30 text-white text-4xl font-medium mt-40 w-3/5"><span className="font-semibold">Hola mundo, soy<br /> <span className="text-5xl font-bold">Piero Rolando,</span> </span><br />FullStack developer</h1>
                </div>
