                ...
                <div class="flex justify-center py-60 px-6">
                    ...
                    <div class="w-full xl:w-3/4 lg:w-11/12 flex h-auto">
                        ...
                        <div class="w-full h-auto bg-gray-400 hidden lg:block lg:w-1/2 bg-cover rounded-l-lg"
                            style="background-image: url('https://www.futbolred.com/files/article_main/upwloads/2018/12/02/5c042bc4e3597.jpeg'); background-position: center;"
                        ></div>
                        {/* <!-- Col --> */}
                        <div class="w-full lg:w-1/2 bg-gray-800 p-5 rounded-lg lg:rounded-l-none">
                            ...
                            <form class="px-8 pt-6 pb-8 mb-4 bg-gray-800 rounded">
                                <div class="mb-4">
                                    <label class="block mb-2 text-sm font-bold text-gray-500" for="username"> Username </label>
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 text-sm font-bold text-gray-500" for="password"> Password </label>
