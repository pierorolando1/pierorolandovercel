    ...
    return (
        <div>
            <div className="flex transition-all">
                ...
                <section className="w-1/6 min-h-screen h-full bg-primary-800 overflow-auto md:block hidden text-gray-500 ">
                    ...
                    <button className={ `focus:outline-none transition-all hover:bg-primary-900 w-full flex items-center justify-center lg:py-0 py-2 ${actualPage == page.home ? "bg-primary-900 text-gray-200": ""}`} onClick={() => setActualPage(page.home)}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        <h1 className="p-3 lg:block hidden">Dashboard</h1>
                    </button>
                    <button className={`focus:outline-none transition-all hover:bg-primary-900 w-full flex items-center justify-center lg:py-0 py-2 relative ${actualPage == page.messages ? "bg-primary-900 text-gray-200": ""}`} onClick={() => setActualPage(page.messages)}>
                    ...
                    <button 
                        className={`focus:outline-none transition-all hover:bg-primary-900 w-full flex items-center justify-center lg:py-0 py-2 ${actualPage == page.profile ? "bg-primary-900 text-gray-200": ""}`} 
            ...
            <div className="fixed bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur bottom-0 w-full md:hidden flex justify-evenly items-center py-2 text-gray-500">
                <button onClick={() => setActualPage(page.home)} className="text-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                </button>
                <button onClick={newPost} className="bg-blue-700 bg-opacity-100 text-gray-50 font-black w-8 h-8 rounded-full">+</button>
                <button onClick={openModalToEditProfile} className="text-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
